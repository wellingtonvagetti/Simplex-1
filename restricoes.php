...
{ 
	$conteudo=$conteudo.'<input type="number" name="z'.$i.'" size="3" maxlength="3"> X<sub>'.$i.'</sub>';
...
{ 
	...
	{ 
		$conteudo=$conteudo.'<input type="number" name="r'.$l.'_'.$c.'" size="3" maxlength="3"> X<sub>'.$c.'</sub>';
